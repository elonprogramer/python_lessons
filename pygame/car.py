...
while running:
    ...
    # Корпус машины
    if i != 1024:
        pygame.draw.rect(screen, (0, 0, 255), pygame.Rect(70, 650, 780, 100))
    else:
        pygame.draw.rect(screen, (0, 255, 0), pygame.Rect(70, 650, 780, 100))
    # Переднеё смтекло
    ...
    # туловеще
    # pygame.draw.rect(screen, (0, 255, 0), (400, 550), (400, 650), 30)
